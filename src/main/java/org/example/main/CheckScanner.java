...
public class CheckScanner {
    ...
    public boolean isKingChecked(int col, int row, boolean isWhite) {
        ...
        return ScanStraight(col, row, king, kingCol, kingRow, 0, +1) ||    // up
                ...
                scanForKnight(col, row, king, kingCol, kingRow) || scanForKing(king, kingCol, kingRow) ||  scanForPawn(col, row, king, kingCol, kingRow);
    }
...
//    find total valid moves on curr pos
//    if 0 valid moves -> checkmate
